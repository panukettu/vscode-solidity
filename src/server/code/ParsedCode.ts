...
export class ParsedCode {
  ...
  public createInfo(
    ...
    const objectTypeString = objectType
      ? objectType
      : this.getParsedObjectType().toLowerCase();
  ...
  public findMethodsInScope(
    ...
    if (this.contract === null) {
      result = result.concat(
        this.document.findMethodCalls(name, includeExtendedMethods)
      );
    } else {
      result = result.concat(
        this.contract.findMethodCalls(name, includeExtendedMethods)
      );
    }
  ...
  public getSelectedFunction(
    ...
    if (this.contract === null) {
      ...
      const allFuncs = this.document.getAllGlobalFunctions(
        includeExtendedMethods
      );
