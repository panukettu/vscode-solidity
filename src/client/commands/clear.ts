...
export const commandClearDiagnostics = (state: ClientState) => async (...args: [boolean, ...any[]]) => {
	...
	await vscode.commands.executeCommand(SERVER_COMMANDS_LIST["diagnostic.clear"], ...args)
}
